...
1. **Clonar el repositorio:** `git clone https://github.com/MatiasTello14/Club-de-la-Hamburguesa---PNT1.git`
2. **Configurar la Base de Datos:** Editar el archivo `appsettings.json` y actualizar la cadena de conexión (`ConnectionString`) con tu instancia local de SQL Server.
3. **Generar las tablas:** Abrir la *Consola del Administrador de Paquetes NuGet* en Visual Studio y ejecutar:  
   `Update-Database`
4. **Ejecutar:** Presionar `F5` o el botón de Play en Visual Studio.
